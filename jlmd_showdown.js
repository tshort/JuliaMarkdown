...
//
    ...
    text = _DoJuliaCalculateButton(text);
	text = _DoJuliaGithubCodeBlocks(text);
...
var _DoJuliaCalculateButton = function(text) {
//
...
//
	...
	text = text.replace(/\[\[\[Calculate\]\]\]/g,
		'<input type="button" onclick="javascript:jlmd.calculate()" value="Calculate"></input>');
...
var id = generateId("jlmd_res_", 1);

var _DoJuliaGithubCodeBlocks = function(text) {
//
